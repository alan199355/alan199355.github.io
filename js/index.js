...
// 侧边导航文字切换
	...
	$("#exp_timeline a").click(function(){
			$("#exp_list_content").stop(true,false).animate({left:-$(".exp_list").width()*$(this).index()},2000,"easeOutElastic");
			page=$(this).index()+1;
	});
	...
	var size=$(function(){
		...
		$("#contact_content").css({"padding-top":($(".active").height()-$("#contact_content").height())/6});
	});
